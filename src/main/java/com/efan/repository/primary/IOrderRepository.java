...
public interface IOrderRepository extends JpaRepository<Order,Long> {
    ...
    @Query("select u from Order u where u.boxId=:boxId and u.state=1 and u.userKey=:userKey  and u.fromTime<:a  and u.toTime>:a order by  u.creationTime ")
    ...
    Page<Order> findAllByUserKeyOrderByCreationTimeDesc(String userKey, Pageable pageable   );
